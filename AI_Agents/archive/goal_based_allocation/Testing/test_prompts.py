...
def _make_full_state() -> dict:
    return {
        ...
        "step1_emergency": {
            "output": {
                "remaining_corpus": 2_820_000,
                "subgroup_amounts": {"debt_subgroup": 180_000},
            }
        },
        "step2_short_term": {
            "output": {
                "remaining_corpus": 2_020_000,
                "subgroup_amounts": {"debt_subgroup": 800_000},
            }
        },
        "step3_medium_term": {
            "output": {"remaining_corpus": 1_020_000, "subgroup_amounts": {}}
        },
...
def test_slim_for_step2_has_step1_output():
    ...
    assert (
        slim["step1_emergency"].get("output", {}).get("remaining_corpus") == 2_820_000
    )
