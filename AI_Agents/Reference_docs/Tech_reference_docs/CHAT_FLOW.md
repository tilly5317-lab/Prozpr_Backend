...
- **It also flags what data the answer will need**, separately from the topic. Today that's one flag: does answering this need a view on the market? It's a deliberately separate decision, because the two questions have different answers — someone asking how their portfolio did against the Nifty is asking about *their own returns*, not about the market.
