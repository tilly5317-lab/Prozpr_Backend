...
> **About this document:** This is a directional reference for how we turn an ideal allocation into a practical one — the philosophy, not the formula. The exact caps, bands and routing rules are proprietary and are deliberately not reproduced here. The companion `Asset_Allocation.md` covers the ideal targets this engine starts from.
...
Three adjustments shape the long-term growth bucket: locked tax-saving units are counted toward your growth target but left untouched; direct-stock and PMS exposure is recognised up to its sensible ceiling; and any concentration above that ceiling is set aside as an amount to reduce.

### Stage 3 — Place the core diversified holding

A diversified, tax-efficient core holding is sized the same way it is in the ideal portfolio — large enough to do real diversification work, bounded so it never dominates the growth allocation.

### Stage 4 — Fill in the remaining growth styles

Whatever growth allocation is left after the core and the untradeable holdings is split across the same eligible equity styles as the ideal portfolio, under the same valuation and market-view discipline. Because this leftover pool can be small for clients with large locked or direct holdings, it naturally consolidates into fewer meaningful positions.
...
| **Why is my direct-stocks holding being trimmed but not someone else's?** | Direct stocks and PMS are capped as a share of your long-term growth allocation, with the cap level set by the size of your overall wealth — more headroom for larger portfolios that can carry concentration, less for smaller ones. Your advisor can also set a different ceiling for your situation, which then applies instead of the wealth-based default — you always see the limit actually being used, not a generic one. Above the ceiling we ask you to reduce; below it, the holding is absorbed into your growth allocation and left alone. We don't pick which individual stocks to sell — that's a decision for you and your advisor. |
...
This document is a directional reference. It is not a tax-planning tool, not a stock-picker, and not a substitute for the actual allocation, which is always personalised to your corpus, your wealth, your locked units and your direct holdings. The caps, ceilings and routing rules behind it are reviewed periodically and may evolve. When they do, this thesis is updated and dated.
