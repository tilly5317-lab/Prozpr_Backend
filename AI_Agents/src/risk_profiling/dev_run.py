...
PROFILES = [
    ...
    _p(
        ...
        1,
        5.0,
        "savings_rate negative → equity_reduce",
    ),
    # ── Retired / no income ──────────────────────────────────────────────────
    ...
    _p(
        ...
        0,
        8.0,
        "high assets no property no debt",
    ),
    ...
    _p(
        ...
        1,
        10.0,
        "high willingness young → gap likely small",
    ),
    ...
    _p(
        ...
        1,
        9.0,
        "gap > 3: high willingness moderate cap",
    ),
    _p(
        60,
        RET,
        ...
        2,
        1.0,
        "gap > 3: low willingness high capacity",
    ),
    ...
    _p(
        ...
        1,
        7.0,
        "exp_coverage: zero expenses → score 10",
    ),
    _p(
        40,
        PVT,
        ...
        1,
        5.0,
        "exp_coverage ratio 0.5 → border score 1",
    ),
    _p(
        40,
        PVT,
        ...
        1,
        7.0,
        "exp_coverage ratio 12.5 → score 10",
    ),
    _p(
        40,
        PVT,
        ...
        1,
        7.0,
        "exp_coverage ratio 6 → mid score",
    ),
    ...
    _p(
        ...
        2,
        10.0,
        "max risk: young public rich willingness 10",
    ),
    _p(
        25, PUB, 1500000, 300000, 2000000, 0, 0, 1, 9.0, "high risk young public sector"
    ),
    ...
    _p(
        ...
        0,
        1.0,
        "min risk: old retired broke low willingness",
    ),
    ...
    _p(
        ...
        2,
        8.0,
        "senior professional good assets",
    ),
    _p(
        48,
        COM,
    ...
    _p(
        ...
        2,
        6.0,
        "approaching retirement good assets",
    ),
    _p(
        53,
        PVT,
    ...
    _p(
        ...
        0,
        8.0,
        "young professional saving well",
    ),
    _p(
        33,
        PVT,
    ...
    _p(
        ...
        1,
        6.0,
        "30s professional mortgage",
    ),
    _p(
        43, FAM, 1200000, 960000, 2000000, 400000, 240000, 1, 6.0, "40s family business"
    ),
    _p(
        49,
        PVT,
...
def _run_spot_checks(results: list) -> None:
    ...
    for idx, path, expected, tol in checks:
        ...
        if not ok:
            all_pass = False
        print(
            f"  [{status}] Profile {idx + 1} ({PROFILES[idx].get('label', '')}) — {path} = {val} (expected {expected})"
        )
