...
SUBCAT_TO_MAPPING = {
    ...
    "Ultra Short to Short Term Fund (6-12 months)": (
        "debt_schemes",
        "debt",
        "short_debt",
    ),
    ...
    "Medium Term to Long Term Fund (4-7 years)": (
        "debt_schemes",
        "debt",
        "medium_debt",
    ),
    ...
    # Index / ETF
    "Large Cap Index Linked (Index/ETF)": (
        "other_schemes",
        "equities",
        "low_beta_equities",
    ),
    "Multi Cap Index Linked (Index/ETF)": (
        "other_schemes",
        "equities",
        "medium_beta_equities",
    ),
    "Sectoral & Thematic Index Linked (Index/ETF)": (
        "other_schemes",
        "equities",
        "sector_equities",
    ),
...
def main():
    ...
    with (
        open(input_file, "r", newline="") as fin,
