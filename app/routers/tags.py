...
OPENAPI_TAG_METADATA: list[dict[str, Any]] = [
    ...
    {
        "name": "Auth",
        "description": "Registration, login, JWT tokens, and account updates.",
    },
    {"name": "Onboarding", "description": "Early onboarding profile and other assets."},
    {
        "name": "Profile",
        "description": "Complete profile, risk, tax, and investment preferences.",
    },
    {"name": "Goals", "description": "Financial goals, contributions, and holdings."},
    {
        "name": "Portfolio",
        "description": "Portfolios, allocations, holdings, and Finvu sync.",
    },
    ...
    {"name": "Rebalancing", "description": "Rebalancing recommendations."},
    {
        ...
        "description": "Investment policy statements.",
    },
    ...
    {
        "name": "MF Data",
        "description": "Mutual fund tables: catalog, NAV, SIPs, ledger, snapshots, AA imports.",
    },
    ...
    {"name": "AI — Mutual fund status", "description": "Mutual fund status (stub)."},
    {
        ...
        "description": "Risk profile module (stub / planned).",
    },
]
