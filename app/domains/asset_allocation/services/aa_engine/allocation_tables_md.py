            ...
            _md_table(
                ...
                [
                    ...
                    [
                        ...
                        doc.get("all_amounts_in_multiples_of_100"),
                    ],
                ],
            ),
            "",
    ...
    def _aggregate_section(label: str, blk: dict[str, Any]) -> list[str]:
        ...
        return [
            ...
            _md_table(
                ...
                [
                    [
                        _inr(blk.get("equity_total")),
                        _pct(blk.get("equity_total_pct")),
                        _inr(blk.get("debt_total")),
                        _pct(blk.get("debt_total_pct")),
                        _inr(blk.get("others_total")),
                        _pct(blk.get("others_total_pct")),
                    ]
                ],
            ),
            "",
        ...
        if pr:
            split_planned_rows.append(
                [
                    key,
                    _inr(pr.get("equity")),
                    _pct(pr.get("equity_pct")),
                    _inr(pr.get("debt")),
                    _pct(pr.get("debt_pct")),
                    _inr(pr.get("others")),
                    _pct(pr.get("others_pct")),
                ]
            )
        ...
        if ar:
            split_actual_rows.append(
                [
                    key,
                    _inr(ar.get("equity")),
                    _pct(ar.get("equity_pct")),
                    _inr(ar.get("debt")),
                    _pct(ar.get("debt_pct")),
                    _inr(ar.get("others")),
                    _pct(ar.get("others_pct")),
                ]
            )
        ...
        [
            ...
            _md_table(
                [
                    ...
                    "subgroup",
                    "planned_amount",
                    "planned_pct_of_bucket",
                    "actual_amount",
                    "actual_pct_of_bucket",
                ],
                subgroup_rows,
            ),
            "",
