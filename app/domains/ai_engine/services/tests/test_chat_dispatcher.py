...
from app.domains.ai_engine.services import chat_dispatcher as cd
...
class RegisterImportSideEffectTests(unittest.TestCase):
    ...
    `from app.domains.ai_engine.services.bridges.asset_allocation import chat as _aa_chat` import
    ...
    def test_importing_asset_allocation_chat_registers_only_asset_allocation(self):
        ...
        cd._HANDLERS.clear()
        from app.domains.ai_engine.services.bridges.asset_allocation import chat as asset_allocation_chat
