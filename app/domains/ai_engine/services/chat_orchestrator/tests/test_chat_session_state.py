...
import app.all_models  # noqa: F401  -- registers every domain's ORM with Base.metadata
...
from app.domains.ai_engine.services.chat_orchestrator.turn_context import build_turn_context
