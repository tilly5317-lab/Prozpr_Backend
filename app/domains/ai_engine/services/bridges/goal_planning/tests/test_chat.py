...
def _stub_dependencies(monkeypatch):
    from app.domains.ai_engine.services.bridges.goal_planning import chat as gp_chat
    from app.domains.ai_engine.services.bridges.goal_planning.service import (
