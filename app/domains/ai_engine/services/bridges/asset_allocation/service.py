...
from app.domains.ai_engine.services.bridges.asset_allocation.input_builder import (
...
async def compute_allocation_result(
    ...
    *,
    ...
    if db is not None and persist_recommendation and output is not None and acting_user_id is not None:
        ...
        from app.domains.ai_engine.services.bridges.asset_allocation.persistence import (
