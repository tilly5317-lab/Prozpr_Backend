...
from app.domains.ai_engine.services.bridges.rebalancing import _disk_cache
...
# table is kept fresh in prod by ``app.domains.mutual_funds.services.mfapi_ingest``.
