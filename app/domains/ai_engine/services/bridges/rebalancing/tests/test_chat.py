...
from app.domains.ai_engine.services.chat_dispatcher import _HANDLERS
from app.domains.ai_engine.services.bridges.rebalancing import chat as mod
from app.domains.ai_engine.services.chat_orchestrator.turn_context import AgentRunRecord, TurnContext
...
def test_register_side_effect_for_rebalancing():
    ...
    import app.domains.ai_engine.services.bridges.rebalancing.chat as mod
...
def test_handle_returns_chat_handler_result_on_success(monkeypatch):
    from app.domains.ai_engine.services.bridges.rebalancing import chat as rb_chat
    from app.domains.ai_engine.services.bridges.rebalancing.service import RebalancingRunOutcome
    ...
    with patch("app.domains.ai_engine.services.answer_formatter.formatter.format_answer",
...
class HandleRoutingTests(unittest.TestCase):
    ...
    def test_first_turn_runs_engine_and_calls_formatter(self):
        ...
        with patch.object(mod, "compute_rebalancing_result",
             ...
             patch("app.domains.ai_engine.services.bridges.rebalancing.chat.build_rebal_facts_pack",
                   return_value={}), \
             patch("app.domains.ai_engine.services.answer_formatter.formatter.record_ai_module_run",
                   new=AsyncMock(return_value=None)):
