...
async def test_rebalancing_chat_dispatch_returns_sectioned_markdown(
    ...
    import app.domains.ai_engine.services.bridges.rebalancing.chat  # noqa: F401
    ...
    with patch(
        "app.domains.ai_engine.services.answer_formatter.formatter.format_answer",
        new=AsyncMock(return_value=_formatter_reply),
    ), patch(
        "app.domains.ai_engine.services.answer_formatter.formatter.record_ai_module_run",
