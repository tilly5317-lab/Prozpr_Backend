...
def test_facts_pack_is_a_plain_dict():
    from app.domains.ai_engine.services.bridges.rebalancing.service import build_rebal_facts_pack
...
def test_fund_actions_caps_at_limit_and_signals_overflow():
    from app.domains.ai_engine.services.bridges.rebalancing.service import (
        FUND_ACTIONS_LIMIT,
        ...
        bucket_allocations=[
            ...
            BucketAllocation(
                ...
                subgroup_amounts={
                    ...
                    "arbitrage_plus_income": 4_000_000,
                    "arbitrage": 1_000_000,
                },
            ),
        ],
...
def test_build_goal_buckets_block_shape():
    from app.domains.ai_engine.services.bridges.rebalancing.service import build_goal_buckets_block
...
def test_fallback_rebal_brief_is_non_empty():
    from app.domains.ai_engine.services.bridges.rebalancing.formatter import build_fallback_rebal_brief
...
async def test_always_runs_allocation_before_rebalancing(
    ...
    with patch(
        "app.domains.ai_engine.services.bridges.rebalancing.service.compute_allocation_result",
...
async def test_allocation_block_propagates(
    ...
    from app.domains.ai_engine.services.bridges.asset_allocation.service import AllocationRunOutcome
    from app.domains.ai_engine.services.bridges.rebalancing.service import (
        compute_rebalancing_result,
    )
