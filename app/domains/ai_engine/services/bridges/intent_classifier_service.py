...
from app.domains.ai_engine.services.common import build_history_block, ensure_ai_agents_path
...
def _strip_canned_redirect_turns(history: list[dict[str, str]]) -> list[dict[str, str]]:
    ...
    from app.domains.ai_engine.services.bridges.general_chat_service import _OOS_REPLIES_BY_SUBREASON
    from app.domains.ai_engine.services.chat_orchestrator.brain import _GOAL_PLANNING_SENTINEL
