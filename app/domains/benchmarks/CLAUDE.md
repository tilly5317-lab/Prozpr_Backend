...
- **First refresh bootstraps an empty index** with a `BACKFILL_YEARS` (5) backfill; otherwise it only refreshes `DEFAULT_LOOKBACK_DAYS` (10). Run the temp scraper for the initial seed in prod.
