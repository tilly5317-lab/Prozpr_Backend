...
from app.domains.mutual_funds.schemas import MfHoldingDetailResponse
from app.domains.mutual_funds.services import holding_detail_service
...
async def get_holding_detail(
    ...
    return await holding_detail_service.build_holding_detail(
