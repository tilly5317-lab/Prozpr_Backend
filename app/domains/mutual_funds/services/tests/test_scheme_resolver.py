...
def test_numeric_amfi_passes_through():
    ...
    assert canonical_scheme_code(amfi="152712", isin="INF666M01LC7", isin_to_amfi=_MAP) == "152712"


def test_isin_resolves_to_amfi():
    assert canonical_scheme_code(amfi=None, isin="INF666M01LC7", isin_to_amfi=_MAP) == "153626"
    # case-insensitive
    assert canonical_scheme_code(amfi=None, isin="inf666m01lc7", isin_to_amfi=_MAP) == "153626"
...
def test_isin_in_amfi_slot_resolves():
    ...
    assert canonical_scheme_code(amfi="INF179K01426", isin=None, isin_to_amfi=_MAP) == "101764"
...
def test_unresolvable_is_preserved_not_dropped():
    ...
    assert canonical_scheme_code(amfi=None, isin="INF000000000", isin_to_amfi=_MAP) == "INF000000000"
