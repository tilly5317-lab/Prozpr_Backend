...
class UserMfLatestSnapshot(CasScoped, Base):
    ...
    current_units: Mapped[float] = mapped_column(
    ...
    absolute_return_pct: Mapped[Optional[float]] = mapped_column(
        Numeric(10, 4), nullable=True
    )
    xirr_pct: Mapped[Optional[float]] = mapped_column(Numeric(10, 4), nullable=True)
    portfolio_weight_pct: Mapped[Optional[float]] = mapped_column(
        Numeric(10, 4), nullable=True
    )
    return_1y_pct: Mapped[Optional[float]] = mapped_column(
        Numeric(10, 4), nullable=True
    )
    return_3y_pct: Mapped[Optional[float]] = mapped_column(
        Numeric(10, 4), nullable=True
    )
    return_5y_pct: Mapped[Optional[float]] = mapped_column(
        Numeric(10, 4), nullable=True
    )
