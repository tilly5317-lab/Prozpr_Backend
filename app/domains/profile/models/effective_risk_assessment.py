...
class EffectiveRiskAssessment(Base):
    ...
    step_name: Mapped[str] = mapped_column(
        String(64), default="risk_profile", nullable=False
    )
    ...
    effective_risk_score: Mapped[Optional[float]] = mapped_column(
        Numeric(7, 4), nullable=True
    )
    risk_capacity_score: Mapped[Optional[float]] = mapped_column(
        Numeric(7, 4), nullable=True
    )
