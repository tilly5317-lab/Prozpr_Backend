...
from app.domains.identity.models import (  # noqa: F401
    user, family_member, linked_account,
)
from app.domains.profile.models import (  # noqa: F401
    personal_finance_profile, risk_profile, effective_risk_assessment,
    investment_profile, investment_constraint, asset_allocation_constraint,
    tax_profile, review_preference, other_investment, user_current_property,
)
...
from app.domains.equities.models import (  # noqa: F401
    ...
    company_metadata, equity_price_history, equity_transaction,
)
...
from app.domains.cashflow.models import (  # noqa: F401
    ...
    assumptions, one_off_event, plan_run,
)
