...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_goal_allocation_runs_user_id", "goal_allocation_runs", ["user_id"]
    )
    op.create_index(
        "ix_goal_allocation_runs_portfolio_id", "goal_allocation_runs", ["portfolio_id"]
    )
    op.create_index(
        "ix_goal_allocation_runs_chat_session_id",
        "goal_allocation_runs",
        ["chat_session_id"],
    )
    ...
    op.create_index(
        "ix_goal_allocation_goals_run_id", "goal_allocation_goals", ["run_id"]
    )
    op.create_index(
        "ix_goal_allocation_goals_financial_goal_id",
        "goal_allocation_goals",
        ["financial_goal_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "total_goal_amount", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "allocated_amount", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column("rationale", sa.Text(), nullable=True),
        sa.Column(
    ...
    op.create_index(
        "ix_goal_allocation_buckets_run_id", "goal_allocation_buckets", ["run_id"]
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "bucket_id", "goal_id", name="uq_goal_allocation_bucket_goals_bucket_goal"
        ),
    )
    op.create_index(
        "ix_goal_allocation_bucket_goals_bucket_id",
        "goal_allocation_bucket_goals",
        ["bucket_id"],
    )
    op.create_index(
        "ix_goal_allocation_bucket_goals_goal_id",
        "goal_allocation_bucket_goals",
        ["goal_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "planned_amount", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "actual_amount", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "equity_amount", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column("debt_amount", sa.Numeric(18, 2), nullable=False, server_default="0"),
        sa.Column(
            "others_amount", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status", REBALANCING_RUN_STATUS, nullable=False, server_default="pending"
        ),
        ...
        sa.Column(
            "knob_snapshot", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "request_input", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        "ix_rebalancing_runs_portfolio_id", "rebalancing_runs", ["portfolio_id"]
    )
    op.create_index(
        "ix_rebalancing_runs_chat_session_id", "rebalancing_runs", ["chat_session_id"]
    )
    op.create_index(
        "ix_rebalancing_runs_source_allocation_run_id",
        "rebalancing_runs",
        ["source_allocation_run_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "total_buy_inr", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "total_sell_inr", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "net_cash_flow_inr", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "total_stcg_realised", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "total_ltcg_realised", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "total_stcg_net_off", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "total_tax_estimate_inr",
            sa.Numeric(18, 2),
            nullable=False,
            server_default="0",
        ),
        sa.Column(
            "total_exit_load_inr", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
        ...
        sa.Column(
            "funds_to_buy_count", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "funds_to_sell_count", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "funds_to_exit_count", sa.Integer(), nullable=False, server_default="0"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "goal_target_inr", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "current_holding_inr", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "suggested_final_holding_inr",
            sa.Numeric(18, 2),
            nullable=False,
            server_default="0",
        ),
        sa.Column(
            "rebalance_inr", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "total_buy_inr", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        ...
        sa.Column(
            "ranks_with_holding", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "ranks_with_action", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        "ix_rebalancing_subgroup_summaries_run_id",
        "rebalancing_subgroup_summaries",
        ["run_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "is_recommended", sa.Boolean(), nullable=False, server_default=sa.true()
        ),
        sa.Column(
        ...
        sa.Column(
            "target_pre_cap_pct", sa.Numeric(7, 4), nullable=False, server_default="0"
        ),
        sa.Column(
            "target_own_capped_pct",
            sa.Numeric(7, 4),
            nullable=False,
            server_default="0",
        ),
        sa.Column(
            "final_target_pct", sa.Numeric(7, 4), nullable=False, server_default="0"
        ),
        sa.Column(
            "final_target_amount", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "present_allocation_inr",
            sa.Numeric(18, 2),
            nullable=False,
            server_default="0",
        ),
        sa.Column(
            "invested_cost_inr", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "st_value_inr", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column("st_cost_inr", sa.Numeric(18, 2), nullable=False, server_default="0"),
        sa.Column(
            "lt_value_inr", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column("lt_cost_inr", sa.Numeric(18, 2), nullable=False, server_default="0"),
        sa.Column(
            "exit_load_pct", sa.Numeric(7, 4), nullable=False, server_default="0"
        ),
        sa.Column("exit_load_months", sa.Integer(), nullable=False, server_default="0"),
        sa.Column(
            "units_within_exit_load_period",
            sa.Numeric(20, 6),
            nullable=False,
            server_default="0",
        ),
        ...
        sa.Column(
            "exit_load_amount", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        ...
        sa.Column(
            "worth_to_change", sa.Boolean(), nullable=False, server_default=sa.false()
        ),
        ...
        sa.Column(
            "pass1_buy_amount", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "pass1_underbuy_amount",
            sa.Numeric(18, 2),
            nullable=False,
            server_default="0",
        ),
        sa.Column(
            "pass1_sell_amount", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "pass1_undersell_amount",
            sa.Numeric(18, 2),
            nullable=False,
            server_default="0",
        ),
        sa.Column(
            "pass1_sell_lt_amount",
            sa.Numeric(18, 2),
            nullable=False,
            server_default="0",
        ),
        sa.Column(
            "pass1_realised_ltcg", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "pass1_sell_st_amount",
            sa.Numeric(18, 2),
            nullable=False,
            server_default="0",
        ),
        sa.Column(
            "pass1_realised_stcg", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
        ...
        sa.Column(
            "pass1_undersell_due_to_stcg_cap",
            sa.Numeric(18, 2),
            nullable=False,
            server_default="0",
        ),
        sa.Column(
            "pass1_blocked_stcg_value",
            sa.Numeric(18, 2),
            nullable=False,
            server_default="0",
        ),
        ...
        sa.Column(
            "stcg_offset_amount", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "pass2_sell_amount", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "pass2_undersell_amount",
            sa.Numeric(18, 2),
            nullable=False,
            server_default="0",
        ),
        sa.Column(
            "final_holding_amount",
            sa.Numeric(18, 2),
            nullable=False,
            server_default="0",
        ),
        ...
        sa.UniqueConstraint(
            "run_id", "isin", "rank", name="uq_rebalancing_fund_rows_run_isin_rank"
        ),
    )
    op.create_index(
        "ix_rebalancing_fund_rows_run_id", "rebalancing_fund_rows", ["run_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_rebalancing_trades_run_action", "rebalancing_trades", ["run_id", "action"]
    )
    ...
    op.create_index(
        "ix_rebalancing_warnings_run_id", "rebalancing_warnings", ["run_id"]
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_rebalancing_fund_rows_run_subgroup", table_name="rebalancing_fund_rows"
    )
    ...
    op.drop_index(
        "ix_rebalancing_subgroup_summaries_run_id",
        table_name="rebalancing_subgroup_summaries",
    )
    ...
    op.drop_index(
        "ix_rebalancing_runs_source_allocation_run_id", table_name="rebalancing_runs"
    )
    ...
    op.drop_index(
        "ix_goal_allocation_bucket_goals_goal_id",
        table_name="goal_allocation_bucket_goals",
    )
    op.drop_index(
        "ix_goal_allocation_bucket_goals_bucket_id",
        table_name="goal_allocation_bucket_goals",
    ...
    op.drop_index(
        "ix_goal_allocation_buckets_run_id", table_name="goal_allocation_buckets"
    )
    ...
    op.drop_index(
        "ix_goal_allocation_runs_chat_session_id", table_name="goal_allocation_runs"
    )
    op.drop_index(
        "ix_goal_allocation_runs_portfolio_id", table_name="goal_allocation_runs"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "amount_needed", sa.Numeric(18, 2), nullable=False, server_default="0"
        ),
